  ...
  <div class="site-wrap">
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-12 section-title text-center mb-5">
            ...
            <form action="productList" method="get" name="searchForm">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 col-md-6">
            ...
            <div class="wine_v_1 text-center pb-4">
              <a href="Certification.jsp?p_number=${product.p_number}&page=${paging.page}" class="thumbnail d-block mb-4"><img src="./Resource/images/${product.p_file}" width="200" height="200"></a>
              <div>
                <h3 class="heading mb-1"><a href="#">${product.p_name}</a></h3>
              ...
              <div class="wine-actions">
                ...
                <h3 class="heading-2"><a href="#">${product.p_name}</a></h3>
                <span class="price d-block">${product.p_price}</span>
    ...
    <div class="row mb-5">
          <div class="col-12 section-title text-center mb-5">
			...
			<c:if test="${paging.page>1}">
				<a href="productList?page=${paging.page-1}&search=${requestScope.search}&searchflag=true">[이전]</a>&nbsp;
			</c:if>
			...
			<c:if test="${paging.page<paging.maxPage}">
				<a href="productList?page=${paging.page+1}&search=${requestScope.search}&searchflag=true">[다음]</a>
			</c:if>
		</div>
	</div>
