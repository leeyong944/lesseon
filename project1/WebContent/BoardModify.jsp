...
<head>
  ...
  <script>
  	function modify(){
  		var passwordConfirm=document.getElementById("b_password").value;
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <form action="boardModifyProcess" method="post" id="modifyForm">
              
                  <div class="row">
                      <div class="col-md-6 form-group">
                          <label for="id">아이디</label>
                          <input type="text" id="id" name="id" class="form-control form-control-lg" value="${boardView.id}" readonly>
                      </div>
                      <div class="col-md-6 form-group">
                          <label for="b_password">비밀번호</label>
                          <input type="text" id="b_password" name="b_password" class="form-control form-control-lg">
                      </div>
                  </div>
                  <div class="row">
                      <div class="col-md-6 form-group">
                          <label for="b_categori">문의상품</label>
                          <select id="b_categori" name="b_categori" class="form-control form-control-lg">
                          	<option value="보드카" selected>보드카</option>
                  ...
                  <div class="row">
                      <div class="col-md-12 form-group">
                          ...
                          <textarea id="b_contents" name="b_contents" cols="30" rows="10" class="form-control"></textarea>
                      </div>
                  </div>
                  <input type="hidden" name="b_number" value="${boardView.b_number}">

              
            </form>
            <div class="row">
                      <div class="col-12">
                          <button class="btn btn-primary py-3 px-5" onclick="modify()">수정하기</button>
                      </div>
                  </div>
          </div>
