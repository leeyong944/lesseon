...
import service.ProductQnAService;

import java.util.*;

@WebServlet("/productQnA")
public class ProductQnAController extends HttpServlet {
    ...
    protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	ProductQnAService pqs = new ProductQnAService();
    	
    	
    	int page = 1; //처음 기본값 1페이지 시작
    	int limit = 10; //한페이지에 몇개의 글을 보여줄것인지
    	...
    	List<BoardDTO> boardList = pqs.boardList(startRow, endRow);
    	...
    	RequestDispatcher dispatcher =
    			request.getRequestDispatcher("ProductQnA.jsp");
