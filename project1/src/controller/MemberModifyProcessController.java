...
public class MemberModifyProcessController extends HttpServlet {
    ...
    protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	String id, pw, name, address1, address2, address3, address4, address5, tel, gender, email;
    	id = request.getParameter("m_id");
    	pw = request.getParameter("m_pw1");
    	...
    	MemberModifyProcessService mmps = new MemberModifyProcessService();
    	int result = mmps.memberModify(memberDTO);
    	if(result > 0) {
