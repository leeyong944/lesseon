...
public class TestController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("date1의 값 : "+data1+" ,date2의 값 : "+data2);
		
		//DB에 data1, data2 저장하기
		//저장하는 과정 : InputDB.jsp -> InputController -> InputService -> DAO -> DB의 test 테이블
...
//		dispatcher.forward(request, response);
		...
		/*
		  ...
		  4. application : 서버가 구동되고 있는 동안에 유효
		  		...
		  		계속 유저됨.
		 */
		// request 영역에 데이터 저장해서 RedirectResult.jsp 로 이동
...
//		dispatcher.forward(request, response);
		 ...
		 *	  - Service 클래스 : controller 에서 넘겨받은 내용에 대한 처리및
